...
function AcessibilidadePage() {
    return (
        ...
        <main id="main-acessibilidade" className={styles.acessibilidade}>
            ...
            <section className={styles.paginaAcessibilidade}>
                ...
                <p>Este site é acessível em LIBRAS através do <a id="vlibraslink" href="http://www.vlibras.gov.br/" target="_blank">VLibras</a>.</p>
